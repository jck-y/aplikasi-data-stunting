  ...
  return (
    <View style={styles.container}>
        <View style={styles.container2}>
            ...
            <Text style={styles.usertext}>Olivia</Text>
        </View>
        <View style={styles.container1}>
          <Text style={styles.title}>Nama                :</Text>
          <Text style={styles.text}>Olivia Rhye</Text>
        </View>
        <View style={styles.container1}>
          <Text style={styles.title}>Alamat              :</Text>
          <Text style={styles.text}>Sukur, Airmadidi, North Minahasa Regency, North Sulawesi, Indonesia</Text>
        </View>
        <View style={styles.container1}>
          <Text style={styles.title}>Tinggi                :</Text>
          <Text style={styles.text}>178</Text>
        </View>
        <View style={styles.container1}>
